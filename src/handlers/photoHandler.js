export function photoHandler() {
  ...
  const bizPhoto = {
    src: "img/IMG_6571.webp",
    alt: "Picture of Greg Siekman smiling, wearing a white dress shirt and blue blazer",
  };
  const socialPhoto = {
    src: "img/socialpic.webp",
    alt: "Picture of Greg Siekman on the other side of a screen, looking into the distance holding his brown tabby cat Chauncey who is doing the same.",
  };
  ...
  if (page === "portfolio.html" || page === "portfolio") {
    document.querySelectorAll(".portfolio-images").forEach((imgEl) => {
